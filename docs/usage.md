...
# mkfastq: Usage
=======
# nf-core/rhreynolds-mkfastq: Usage
>>>>>>> TEMPLATE
...
```console
<<<<<<< HEAD
nextflow run RHReynolds/mkfastq --input samplesheet.csv --genome GRCh37 -profile docker
=======
nextflow run nf-core/rhreynolds-mkfastq --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile docker
>>>>>>> TEMPLATE
```
...
=======
nextflow pull nf-core/rhreynolds-mkfastq
>>>>>>> TEMPLATE
```
...
<<<<<<< HEAD
First, go to the [RHReynolds/mkfastq releases page](https://github.com/RHReynolds/mkfastq/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
=======
First, go to the [nf-core/rhreynolds-mkfastq releases page](https://github.com/nf-core/rhreynolds-mkfastq/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
>>>>>>> TEMPLATE
